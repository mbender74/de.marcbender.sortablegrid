...
{
    NSLog(@"[INFO] dimensionForAttributes: ");
...
{
    NSLog(@"[INFO] fixedDimensionForAttributes: ");
...
{
    NSLog(@"[INFO] maxEdgeForAttributes: ");
...
{
    NSLog(@"[INFO] dimensionForSection: ");
...
{
    NSLog(@"[INFO] lastAttributesOfSection: ");
...
{
    NSLog(@"[INFO] addAttributes toSection: ");
...
{
    NSLog(@"[INFO] updateLongestAndShortestDataWithAttributes: ");
...
{
    NSLog(@"[INFO] shortestSectionUpTo: ");
...
{
    NSLog(@"[INFO] updateShortestSection: ");
...
{
    NSLog(@"[INFO] calculateAttributesFrame: ");
...
{
    NSLog(@"[INFO] ensureTrailingItemsDoNotStickOut: ");
