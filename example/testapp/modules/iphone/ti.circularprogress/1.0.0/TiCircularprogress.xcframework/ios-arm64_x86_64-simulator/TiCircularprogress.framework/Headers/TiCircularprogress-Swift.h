...
#ifndef TICIRCULARPROGRESS_SWIFT_H
#define TICIRCULARPROGRESS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TiCircularprogress",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC18TiCircularprogress18KDCircularProgress")
@interface KDCircularProgress : UIView <CAAnimationDelegate>
@property (nonatomic, strong) TiViewProxy * _Nonnull myProxy;
@property (nonatomic, strong) NSNumber * _Nonnull progress;
...
- (void)layoutSubviews;
- (void)animateFromAngle:(double)fromAngle toAngle:(double)toAngle duration:(NSTimeInterval)duration relativeDuration:(BOOL)relativeDuration proxy:(TiViewProxy * _Nonnull)proxy completion:(void (^ _Nullable)(BOOL))completion;
- (void)animateToAngle:(double)toAngle duration:(NSTimeInterval)duration relativeDuration:(BOOL)relativeDuration proxy:(TiViewProxy * _Nonnull)proxy completion:(void (^ _Nullable)(BOOL))completion;
- (void)pauseAnimation;
- (void)stopAnimation;
